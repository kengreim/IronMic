...
namespace Blazor.Components.Primitives;

/// <summary>
///     A component that renders an anchor tag, automatically toggling its 'active'
///     class based on whether its 'href' matches the current URI.
/// </summary>
public class TailwindNavLink : ComponentBase, IDisposable
{
    ...
    {
        CssClass = _isActive
            ? CombineWithSpace(CombineWithSpace(_class, BaseClass ?? ""), ActiveClass ?? DefaultActiveClass)
            : CombineWithSpace(CombineWithSpace(_class, BaseClass ?? ""), InactiveClass ?? "");
    }
    ...
    private bool ShouldMatch(string currentUriAbsolute)
    {
        ...
        if (EqualsHrefExactlyOrIfTrailingSlashAdded(currentUriAbsolute)) return true;
    ...
    private bool EqualsHrefExactlyOrIfTrailingSlashAdded(string currentUriAbsolute)
    {
        ...
        if (string.Equals(currentUriAbsolute, _hrefAbsolute, StringComparison.OrdinalIgnoreCase)) return true;
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        if (_isActive) builder.AddAttribute(3, "aria-current", "page");
