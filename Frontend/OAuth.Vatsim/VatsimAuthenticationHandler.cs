...
public partial class VatsimAuthenticationHandler : OAuthHandler<VatsimAuthenticationOptions>
{
    public VatsimAuthenticationHandler(
        IOptionsMonitor<VatsimAuthenticationOptions> options,
